...
base_dir = f'/run/user/1003/gvfs/smb-share:server=tierra.cnic.es,share=sc/LAB_MT/RESULTADOS/U_Bioinformatica/Morena/2025/' # MeisdKO_WT_mTmG_Columnarity
...
def marching_cubes(img, metadata):
    ...
    print(f'{c.OKGREEN}Filtered cells{c.ENDC}: {len(cell_data_list)} / {past_cells} ({100 * len(cell_data_list) / past_cells:.2f}%)')
